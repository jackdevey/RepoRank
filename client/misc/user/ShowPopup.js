        ...
        children: (
            <>
                <Group noWrap style={{ paddingBottom: "30px" }}>
                        <Avatar src={user.avatarUrl} radius="xl" size="xl" />
                        <div>
                ...
                <Grid>
                    ...
                    <Grid.Col lg={6} sm={12}>
                        ...
                        <Accordion iconPosition="right" offsetIcon={false}>
                            ...
                            <Accordion.Item label={<Text>Discussion comments 💭 <PointsPopup points={user.score.discussionComments} maximum={25} /></Text>}>
